function t(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function r(i){return i||""}function b(i){const o=i.layout||"a",e=y[i.template];return(e==null?void 0:e[o])??(e==null?void 0:e.a)??y.dark.a}const $={cover:{a:"Ancorado",b:"Editorial",c:"Linha de corte"},dark:{a:"Stacked",b:"Nº fundo",c:"2 colunas"},steps:{a:"Lista",b:"Numerado",c:"Ícones"},overlay:{a:"Foto topo",b:"Full-bleed"},split:{a:"Padrão"},cta:{a:"Headline",c:"Centrado"}},c=i=>`font-family:'${(i==null?void 0:i.font_display)||"Playfair Display"}',serif;`,n=i=>`font-family:'${(i==null?void 0:i.font_body)||"Inter"}',sans-serif;`;function m(i){const o=i.img_position;if(!o)return"";const e=o.x??50,a=o.y??50,l=o.scale??1;return`object-position:${e}% ${a}%;transform:scale(${l});transform-origin:${e}% ${a}%;`}function v(i){const o=(i==null?void 0:i.nav_left)||"CATEGORIA",e=(i==null?void 0:i.nav_right)||"SÉRIE";return`<div style="${n(i)}display:flex;align-items:center;gap:22px;font-size:22px;letter-spacing:.18em;color:#303030;text-transform:uppercase;margin-bottom:96px;">
    <span>${t(o)}</span>
    <div style="flex:1;height:1px;background:#1e1e1e;"></div>
    <span>${t(e)}</span>
  </div>`}function h(i){const o=(i==null?void 0:i.brand_symbol)||"⬥",e=(i==null?void 0:i.brand_name)||"Marca";return`<div style="${n(i)}display:flex;justify-content:space-between;align-items:center;margin-top:auto;padding-top:36px;">
    ...
    <span style="font-size:22px;letter-spacing:.14em;color:#252525;text-transform:uppercase;">${t(e.toUpperCase())}</span>
  </div>`}const y={cover:{a(i,o,e){const a=o?`<div style="position:absolute;inset:0;"><img src="${o}" style="width:100%;height:100%;object-fit:cover;${m(i)}filter:saturate(0.6);"><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.97) 0%,rgba(0,0,0,.6) 42%,transparent 72%);"></div></div>`:'<div style="position:absolute;inset:0;background:linear-gradient(160deg,#2a3540,#1a2228);"></div>',l=(e==null?void 0:e.brand_symbol)||"⬥",s=(e==null?void 0:e.brand_name)||"Marca",d=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),x=r(i.body_html||t(i.body||""));return`<div style="position:relative;width:1080px;height:1350px;overflow:hidden;background:#000;">
        ${a}
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          <div style="${n(e)}font-size:22px;color:#fff;opacity:.9;">${t(l)} ${t(s)}</div>
      ...
      </div>`},b(i,o,e){const a=o?`<div style="position:absolute;inset:0;"><img src="${o}" style="width:100%;height:100%;object-fit:cover;${m(i)}filter:saturate(0.6);"><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.97) 0%,rgba(0,0,0,.6) 42%,transparent 72%);"></div></div>`:'<div style="position:absolute;inset:0;background:linear-gradient(160deg,#2a3540,#1a2228);"></div>',l=(e==null?void 0:e.brand_symbol)||"⬥",s=(e==null?void 0:e.brand_name)||"Marca",d=(e==null?void 0:e.nav_left)||"CATEGORIA",x=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),p=r(i.body_html||t(i.body||""));return`<div style="position:relative;width:1080px;height:1350px;overflow:hidden;background:#000;">
        ${a}
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
      ...
      </div>`},c(i,o,e){const a=o?`<div style="position:absolute;inset:0;"><img src="${o}" style="width:100%;height:100%;object-fit:cover;${m(i)}filter:saturate(0.6);"><div style="position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.97) 0%,rgba(0,0,0,.7) 55%,rgba(0,0,0,.3) 100%);"></div></div>`:'<div style="position:absolute;inset:0;background:#050505;"></div>',l=(e==null?void 0:e.brand_symbol)||"⬥",s=(e==null?void 0:e.brand_name)||"Marca",d=(e==null?void 0:e.nav_left)||"CATEGORIA",x=(e==null?void 0:e.nav_right)||"SÉRIE",p=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),f=r(i.body_html||t(i.body||""));return`<div style="position:relative;width:1080px;height:1350px;overflow:hidden;background:#000;">
        ${a}
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
            <div style="${n(e)}font-size:22px;color:#fff;opacity:.85;">${t(l)} ${t(s)}</div>
      ...
      </div>`}},split:{a(i,o,e){const a=o?`<img src="${o}" style="width:100%;height:100%;object-fit:cover;${m(i)}filter:grayscale(90%) contrast(1.05);">`:'<div style="width:100%;height:100%;background:linear-gradient(160deg,#2a3540,#1a2228);"></div>',l=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),s=r(i.body_html||t(i.body||""));return`<div style="width:1080px;height:1350px;display:flex;background:#000;">
        <div style="flex:0 0 52%;display:flex;flex-direction:column;padding:54px 52px 60px 76px;">
          ...
          <div style="${n(e)}font-size:27px;color:#777;line-height:1.5;margin-bottom:auto;">${s}</div>
          ${h(e)}
        </div>
        <div style="flex:0 0 48%;overflow:hidden;">${a}</div>
      </div>`}},dark:{a(i,o,e){const a=(i.list_items||[]).map(d=>`<div style="display:flex;gap:16px;margin-bottom:16px;">
        ...
        <div style="${n(e)}font-size:27px;color:#666;line-height:1.5;margin-bottom:32px;">${l}</div>
        <div style="margin-bottom:24px;">${a}</div>
        <div style="${n(e)}font-size:27px;color:#555;line-height:1.5;margin-bottom:auto;">${s}</div>
        ${h(e)}
      </div>`},b(i,o,e){const a=(i.list_items||[]).map(g=>`<div style="display:flex;gap:28px;margin-bottom:22px;align-items:baseline;">
         ...
         </div>`).join(""),l=(e==null?void 0:e.nav_left)||"CATEGORIA",s=(e==null?void 0:e.nav_right)||"SÉRIE",d=(e==null?void 0:e.brand_symbol)||"⬥",x=(e==null?void 0:e.brand_name)||"Marca",p=r(i.body_html||t(i.body||"")),f=r(i.conclusion_html||t(i.conclusion||""));return`<div style="width:1080px;height:1350px;background:#060606;display:flex;flex-direction:column;padding:54px 76px 80px;position:relative;overflow:hidden;">
        ...
        <div style="display:flex;align-items:center;gap:22px;font-size:0;padding-bottom:40px;position:relative;">
          <span style="${n(e)}font-size:18px;letter-spacing:.18em;color:#282828;text-transform:uppercase;">${t(l)}</span>
          <div style="flex:1;height:1px;background:#1e1e1e;"></div>
      ...
      </div>`},c(i,o,e){const a=(i.list_items||[]).map(g=>`<div style="display:flex;gap:28px;margin-bottom:22px;align-items:baseline;">
          <span style="${n(e)}color:#555;font-size:27px;flex-shrink:0;">·</span>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          ...
          <span style="${n(e)}font-size:27px;font-weight:500;color:#fff;">${t(s.label)}:</span>
          <span style="${n(e)}font-size:27px;color:#666;"> ${r(s.text_html||t(s.text||""))}</span>
        ...
        ${h(e)}
      </div>`},b(i,o,e){const a=(i.steps||[]).map(f=>{var g;return`<div style="display:flex;align-items:baseline;gap:36px;margin-bottom:32px;">
        ...
        </div>`}).join(""),l=(e==null?void 0:e.nav_left)||"CATEGORIA",s=(e==null?void 0:e.nav_right)||"SÉRIE",d=(e==null?void 0:e.brand_symbol)||"⬥",x=(e==null?void 0:e.brand_name)||"Marca",p=r(i.call_to_action_html||(i.call_to_action?t(i.call_to_action)+(i.call_to_action_italic?" <em>"+t(i.call_to_action_italic)+"</em>":""):""));return`<div style="width:1080px;height:1350px;background:#000;display:flex;flex-direction:column;padding:54px 76px 80px;">
        <div style="display:flex;align-items:center;gap:22px;margin-bottom:48px;">
          <span style="${n(e)}font-size:18px;letter-spacing:.18em;color:#282828;text-transform:uppercase;">${t(l)}</span>
          <div style="flex:1;height:1px;background:#1e1e1e;"></div>
          <span style="${n(e)}font-size:18px;letter-spacing:.18em;color:#282828;text-transform:uppercase;">${t(s)}</span>
        ...
        <div style="flex:1;padding:32px 62px 60px;display:flex;flex-direction:column;">
          ...
          <div style="${n(e)}font-size:24px;color:#666;line-height:1.5;margin-bottom:auto;">${l}</div>
          ${h(e)}
        </div>
      </div>`},b(i,o,e){const a=o?`<img src="${o}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;${m(i)}">`:'<div style="position:absolute;inset:0;background:linear-gradient(160deg,#2a3540,#1a2228);"></div>',l=(e==null?void 0:e.brand_symbol)||"⬥",s=(e==null?void 0:e.brand_name)||"Marca",d=(e==null?void 0:e.nav_left)||"CATEGORIA",x=(e==null?void 0:e.nav_right)||"SÉRIE",p=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),f=r(i.body_html||t(i.body||""));return`<div style="width:1080px;height:1350px;background:#000;position:relative;overflow:hidden;">
        ${a}
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;">
            <span style="${n(e)}font-size:22px;color:#1e1e1e;">${t(l)} ${t(s)}</span>
            <span style="${n(e)}font-size:22px;letter-spacing:.14em;color:#1a1a1a;text-transform:uppercase;">${t(s)}</span>
          </div>
        </div>
      </div>`}},cta:{a(i,o,e){const a=(e==null?void 0:e.brand_symbol)||"⬥",l=(e==null?void 0:e.brand_name)||"Marca",s=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),d=r(i.body_html||t(i.body||""));return`<div style="width:1080px;height:1350px;background:#000;border:1px solid #161616;display:flex;flex-direction:column;padding:54px 76px 80px;">
        <div style="${n(e)}font-size:22px;color:#fff;margin-bottom:auto;">${t(a)} ${t(l)}</div>
      ...
      </div>`},c(i,o,e){const a=(e==null?void 0:e.brand_symbol)||"⬥",l=(e==null?void 0:e.brand_name)||"Marca",s=r(i.headline_html||(i.headline?t(i.headline)+(i.headline_italic?" <em>"+t(i.headline_italic)+"</em>":""):"")),d=r(i.body_html||t(i.body||""));return`<div style="width:1080px;height:1350px;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:80px 96px;text-align:center;">
        <div style="${n(e)}font-size:22px;color:#252525;letter-spacing:.18em;margin-bottom:60px;">${t(a)} ${t(l)}</div>
      ...
      </div>`}}};export{$ as LAYOUT_NAMES,y as RENDERERS,b as getRenderer};
